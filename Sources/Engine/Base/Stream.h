...
public:
  ...
  inline CTStream &operator>>(UQUAD &uq) { Read_t(&uq, sizeof(uq)); return *this; } // throw char *
  ...
  inline CTStream &operator>>(SQUAD &sq) { Read_t(&sq, sizeof(sq)); return *this; } // throw char *
  ...
  inline CTStream &operator<<(const UQUAD &uq) { Write_t(&uq, sizeof(uq)); return *this; } // throw char *
  ...
  inline CTStream &operator<<(const SQUAD &sq) { Write_t(&sq, sizeof(sq)); return *this; } // throw char *
