...
public:
  ...
  inline CTStream &operator>>(UQUAD &uq) { Read_t(&ull, sizeof(uq)); return *this; } // throw char *
  ...
  inline CTStream &operator>>(SQUAD &sq) { Read_t(&sll, sizeof(sq)); return *this; } // throw char *
  ...
  inline CTStream &operator<<(const UQUAD &uq) { Write_t(&ull, sizeof(uq)); return *this; } // throw char *
  ...
  inline CTStream &operator<<(const SQUAD &sq) { Write_t(&sll, sizeof(sq)); return *this; } // throw char *
