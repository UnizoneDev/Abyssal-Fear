...
#define _SE_BUILD_MINOR    20   // minor versions that are data-compatibile, but are not netgame-compatibile
#define _SE_BUILD_EXTRA    ""   // extra version with minor code changes
#define _SE_VER_STRING  "1.20"  // usually shown in server browser, etc
