...
void CDrawPort::PutTextLXY(const CTString& strText, PIX pixX0, PIX pixY0,
    const COLOR colBlend/*=0xFFFFFFFF*/) const
{
    PIX pixTextHeight = dp_FontData->fd_pixCharHeight * dp_fTextScaling;
    PutText(strText, pixX0, pixY0 - pixTextHeight / 2, colBlend);
}

// writes text string on drawport (right-aligned arround X and Y)
void CDrawPort::PutTextRXY(const CTString& strText, PIX pixX0, PIX pixY0,
    const COLOR colBlend/*=0xFFFFFFFF*/) const
{
    PIX pixTextHeight = dp_FontData->fd_pixCharHeight * dp_fTextScaling;
    PutText(strText, pixX0 - GetTextWidth(strText), pixY0 - pixTextHeight / 2, colBlend);
}
