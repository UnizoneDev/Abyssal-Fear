...
#define BPOF2_BLOCKHITSCAN      (1UL<<5)  // polygon will block hitscan attacks
#define BPOF2_CASTALPHASHADOWS  (1UL<<6)  // polygon that is transparent will cast shadows based on texture
