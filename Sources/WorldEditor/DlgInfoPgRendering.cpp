...
#define SET_TRI_STATE_TO_CTRL( ctrl, flag)\
  if((ulFlagsOn & flag) && !(ulFlagsOff & flag)) ctrl.SetCheck( 1);\
    ...
    else
    {
      ...
      case STT_INVERT: {            iTranslucency = 5; break; };
      case STT_TRUEMULTIPLY: {      iTranslucency = 6; break; };
      case STT_SPECIAL1: {          iTranslucency = 7; break; };
      case STT_SPECIAL2: {          iTranslucency = 8; break; };
      case STT_SPECIAL3: {          iTranslucency = 9; break; };
      }
...
#define TRI_STATE_CTRL_TO_FLAGS( ctrl, flag)\
  ...
  if( pDX->m_bSaveAndValidate)
  {
    ...
    for( INDEX iSurface=0; iSurface<mmi.mmpi_MappingSurfaces.Count(); iSurface++)
    {
      ...
      case 5: { ms.ms_sttTranslucencyType = STT_INVERT; break; };
      case 6: { ms.ms_sttTranslucencyType = STT_TRUEMULTIPLY; break; };
      case 7: { ms.ms_sttTranslucencyType = STT_SPECIAL1; break; };
      case 8: { ms.ms_sttTranslucencyType = STT_SPECIAL2; break; };
      case 9: { ms.ms_sttTranslucencyType = STT_SPECIAL3; break; };
      }
